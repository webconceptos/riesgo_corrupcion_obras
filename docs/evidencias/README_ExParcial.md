...
## F1 por Modelo  
![F1 por modelo](../reports/graficos/experimentos_f1.png)

## Recall por Modelo  
![Recall por modelo](../reports/graficos/experimentos_recall.png)

## ROC-AUC por Modelo  
![ROC-AUC por modelo](../reports/graficos/experimentos_rocauc.png)
...
![Ablation F1](../reports/graficos/ablation_f1.png)

## Recall por Configuracion  
![Ablation Recall](../reports/graficos/ablation_recall.png)

## ROC-AUC por Configuracion  
![Ablation ROC-AUC](../reports/graficos/ablation_rocauc.png)
...
## SHAP Summary Plot  
![SHAP Summary](../reports/graficos/xai_shap_summary.png)

## SHAP Bar Plot  
![SHAP Bar](../reports/graficos/xai_shap_bar.png)
...
![Distribucion y_riesgo](../reports/graficos/eda_y_riesgo.png)
